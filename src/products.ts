...
import { Items,Item, ItemShortName } from './types'

export let products:Items[]
let SlapYaMama!:ItemShortName, ColonCleaner!:ItemShortName, RRF!:ItemShortName, Generals!:ItemShortName, SatansRage!:ItemShortName, CrazyBastard!:ItemShortName
